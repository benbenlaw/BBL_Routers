...
public class ExporterBlockEntity extends SyncableBlockEntity implements MenuProvider, IAttachmentHolder {

    private List<BlockPos> importerPositions;
    public final ContainerData data;
    public final GlobalPos exporterPos = GlobalPos.of(this.level.dimension(), this.worldPosition);
